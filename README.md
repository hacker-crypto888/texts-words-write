...
| the user dropped a file | <ul><li>[x] file is converted into a blob (object represents a file-like object of immutable, raw data that can be read as text or binary data)</li><li>[x] text is extracted from the blob</li><li>[x] information about this file is saved</li><li>[x] text is put together with other texts</li><li>[x] divs are added in the modal body of the editor for entries</li><li>[x] the words and the buttons to remove them are displayed</li></ul> | 
