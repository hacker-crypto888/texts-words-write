...
| Cancel the edits made to the texts using the editor and save all texts | <ul><li>[ ] </li></ul> | <ul><li>[x] </li></ul> | Each connected user can cancel its edits and save all texts including that from other users |  <ul><li>[ ] </li></ul> | <ul><li>[ ] I added radio buttons to change the display of items according to whether they are texts from previous sessions or uploaded during this session</li><li>[ ] </li><li>[ ] </li><li>[ ] </li><li>[ ] </li><li>[ ] </li><li>[ ] </li><li>[ ] On click of the "save without saving changes" button, the value of the constant variable takes the initial value of the list when the items are loaded. The name of the values for the connected user are: <br/> importedTexts.dataset... <br/> texts => current session <br/> prev => previoous sessions of logged in user <br/> allusers => all users' sessions <br/></li></ul>  
